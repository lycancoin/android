...
public class ECKey implements Serializable {
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by the Xxxxxxx reference
    ...
    public static class ECDSASignature {
         ...
         * of the type used by Xxxxxxx we have to encode them using DER encoding, which is just a way to pack the two
     ...
     * determine if the signature was correct. These sorts of signatures are compatible with the Xxxxxxx-Qt/litecoind
